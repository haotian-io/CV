...
\newcommand{\cvsection}[1]{%
  \vspace{6.1pt}%
  {\sffamily\bfseries\fontsize{10.9}{12.7}\selectfont\color{navy}\MakeUppercase{#1}}\par
  \vspace{1.5pt}%
...
\newcommand{\entryrole}[1]{%
  {\itshape\fontsize{9.25}{11.55}\selectfont\color{muted}#1}\par\vspace{1.0pt}%
}
...
\begin{minipage}[t]{\dimexpr\linewidth-1.08in\relax}
  ...
  \entryrole{B.Eng. in Software Engineering \textbar{} Overall Average: 82.52/100}
  {\fontsize{9.25}{11.55}\selectfont\raggedright
  \textbf{Relevant Coursework:} Machine Learning for Decision-Making and Optimization (96); Algorithms for \mbox{Modern AI (94)}; Introduction to Artificial Intelligence (93); Interactive Design (90); The Practice of Computer \mbox{Programming (92)}.\par}
\end{minipage}
...
\begin{cvitems}
  \item Developed a prototype memory-governance layer with append-only revision records, active-state semantics, risk gating, and governed forgetting.
...
{\fontsize{9.25}{11.55}\selectfont
\textbf{Programming and ML:} Python, PyTorch, Transformers, SQL, Java, Spring Boot, Unity; LLM agents, RAG, multimodal learning, evaluation, and \mbox{information retrieval}.\par
