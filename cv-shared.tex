...
\begin{cvitems}
  ...
  \item Evaluated Llama 3.1 70B across multiple reasoning benchmarks; case-level audits characterized parser, verifier, and repair-selection failures and informed conservative answer-selection gates.
\end{cvitems}
...
\begin{cvitems}
  \item Developed a prototype memory-governance layer combining append-only revisions, active-state semantics, risk-gated conditioning, and governed forgetting for auditable long-horizon agent memory.
